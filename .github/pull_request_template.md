...
## Static boundary (Pages stays deployable)

- [ ] No new dependency outside `index.html` / `app.js` / `styles.css`.
- [ ] No hardcoded localhost, no `http://` API URLs, no secrets committed.

## Notes

<!-- Screenshots, F12 errors, or "n/a". -->
